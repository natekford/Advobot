...
public sealed class MyCommands
{
	...
	[RequireGuild(SERV_ID)]
	[SpanitchRolesExist]
	public sealed class Spanitch : AutoModModuleBase
	{
		internal const ulong MIJE_ID = 107770708142067712;
		internal const ulong MUTE_ID = 328101628664086528;
		internal const ulong SERV_ID = 199339772118827008;
		internal const ulong SPAN_ID = 741058143450300487;
		...
		{
			return Array.ConvertAll(Roles, x => new PersistentRole
			{
