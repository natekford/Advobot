...
public sealed class Notifications
{
	...
	public sealed class ModifyGoodbyeMessage : NotificationModuleBase
	{
		...
		[Command(nameof(Names.Content), nameof(Names.ContentAlias))]
		...
		[Command(nameof(Names.Embed), nameof(Names.EmbedAlias))]
		...
		[Command(nameof(Names.Send), nameof(Names.SendAlias))]
