...
namespace Advobot.Commands.Users
{
	...
	{
		[Command]
		public async Task Command([VerifyObject(false, ObjectVerification.CanBeEdited)] IGuildUser user, [Optional] uint minutesForBan, [Optional, Remainder] string reason)
		{
