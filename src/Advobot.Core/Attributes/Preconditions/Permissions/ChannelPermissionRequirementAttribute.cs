...
namespace Advobot.Attributes.Preconditions.Permissions
{
	...
	public class ChannelPermissionRequirementAttribute : PermissionRequirementAttribute
	{
		/// <summary>
		/// Creates an instance of <see cref="GuildPermissionRequirementAttribute"/>.
		/// </summary>
		/// <param name="permissions"></param>
		public ChannelPermissionRequirementAttribute(params ChannelPermission[] permissions)
