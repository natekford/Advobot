...
public abstract class StringRangeParameterPrecondition
	: AdvobotParameterPrecondition<string>
{
	...
	/// <summary>
	/// Creates an instance of <see cref="StringRangeParameterPrecondition"/>.
	/// </summary>
	/// <param name="min"></param>
	/// <param name="max"></param>
	protected StringRangeParameterPrecondition(int min, int max)
	{
		Range = new(min, max);
	}
