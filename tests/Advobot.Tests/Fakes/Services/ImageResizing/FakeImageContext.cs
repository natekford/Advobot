...
namespace Advobot.Tests.Fakes.Services.ImageResizing
{
	public sealed class FakeImageContext : IImageContext
	{
		...
		public IResult CanUseFormat(MagickFormat format) => throw new NotImplementedException();

		public Task ReportAsync(string value)
			=> Task.CompletedTask;

		public Task SendFinalResponseAsync(IResult result) => throw new NotImplementedException();

		public Task<IResult> UseStream(MemoryStream stream) => throw new NotImplementedException();
	}
}